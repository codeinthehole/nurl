...
Url.prototype.getHash = function() {
    return this.__getProperty('hash');
};
// Alias getFragment to getHash
...
exports.createFromString = function(urlString) {
    ...
    return new Url(protocol, user, password, libUrl.hostname, libUrl.port, libUrl.pathname, search, hash);
};
